"""
Report: Time Per Report
Shows total active time spent in Frappe *query-report* views,
grouped by the report route (docname field stores the report name).
"""
...
def get_data(filters):
	...
	return frappe.db.sql(
		f"""
		SELECT
			COALESCE(`docname`, `route`)         AS docname,
			COUNT(*)                             AS sessions,
